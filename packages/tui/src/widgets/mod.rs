...
pub use visual::{
    looping_visual_spec, visual, CellSample, DissolveMode, GradientDirection, GradientTarget,
    StaggerMode, Visual, VisualAnchor, VisualConfig, VisualCtx, VisualEffect, WaveAxis,
